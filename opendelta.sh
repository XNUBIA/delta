...
BIN_JAVA=java
BIN_MINSIGNAPK=$HOME/delta/bin/minsignapk.jar
BIN_XDELTA=$HOME/delta/bin/xdelta3
BIN_ZIPADJUST=$HOME/delta/bin/zipadjust

FILE_MATCH=lineage-*.zip
PATH_CURRENT=$HOME/laos/out/target/product/$DEVICE
PATH_LAST=$HOME/delta/last/$DEVICE

KEY_X509=$HOME/certs/platform.x509.pem
KEY_PK8=$HOME/certs/platform.pk8
